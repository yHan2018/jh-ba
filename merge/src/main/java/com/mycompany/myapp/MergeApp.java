...
public class MergeApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(MergeApp.class);

    private final Environment env;

    public MergeApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MergeApp.class);
